...
const MyCart = () => {
	...
	useEffect(() => {
		...
		console.log("Filtered", filterCartByUserEmail);
				...
				>
					<div className="mt-4 space-y-6">
						<ul className="space-y-4">
							{carts?.map(cart => {
								const { image, brand_name, product_name, price } = cart || {};
						...
						<div className="space-y-4 text-center">
							...
							<a
								href="#"
								className="block rounded bg-blue-500 px-5 py-3 text-sm text-gray-100 transition hover:bg-blue-400"
							>
								Checkout
							</a>
							<a
