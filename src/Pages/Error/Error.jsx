		...
		<section className="bg-gray-950">
			<div className="container flex items-center min-h-screen px-6 py-12 mx-auto">
				<div className="flex flex-col items-center max-w-sm mx-auto text-center">
					...
					<div className="flex  flex-col lg:flex-row items-center w-full mt-6 gap-5 shrink-0 sm:w-auto">
						<Link
							to={"/"}
						...
						<Link
							to={"/"}
							className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto hover:bg-blue-400 "
						>
							Take me home
						</Link>
					</div>
