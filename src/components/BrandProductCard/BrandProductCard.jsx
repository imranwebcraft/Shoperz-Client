...
const BrandProductCard = ({ product }) => {
	...
	return (
		<div className=" col-span-4 lg:col-span-3">
			<div className=" flex flex-col h-full overflow-hidden rounded bg-white text-slate-500 shadow-md hover:shadow-lg transition-all duration-200 shadow-slate-200">
				{/*  <!-- Image --> */}
				<figure>
